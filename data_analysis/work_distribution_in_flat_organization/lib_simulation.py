...
# problem: unique_id can be set by the user after initialization; see https://stackoverflow.com/a/48709694/1164295
class CreatePerson():
    """
    ...
    def add_person_to_contact_list(self, person_id: int, social_circle_size: int) -> None:
        """
        Intended to capture https://en.wikipedia.org/wiki/Dunbar%27s_number
        """

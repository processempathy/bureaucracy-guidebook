...
The explanations above should convince you that communication is critical for bureaucracy, and essential for being an effective bureaucrat. Communication is typically thought of as occurring between two or more people, but before getting to that we'll focus on your \href{https://en.wikipedia.org/wiki/Intrapersonal_communication}{inner monologue}. 

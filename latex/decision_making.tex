...
More commonly, a decision is made, then data is gathered that supports the desired outcome. Forming an opinion and then looking for evidence to back the outcome yields suboptimal results for the organization but maintains the relationships of the decision-maker. The value to the person using that suboptimal approach is extracted from other members of the organization or subjects of the bureaucracy. 

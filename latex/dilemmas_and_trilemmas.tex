...
%GV "dilemma-personal-manager-micromanaging" [label="review frequency", shape="box"];
...
%GV "dilemma-personal-work-extra-or-work-as-expected" -> "";
\end{table}
\end{center}
...
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
The \hyperref[table:dilemma-personal-gather-data-lots-vs-little]{Dilemma of Data Quantity} is about how much data is needed, whereas the \hyperref[table:dilemma-personal-single-bit-decision]{Dilemma of Data for Decisions} is about the redundancy of data used for coordination. While not unique to bureaucracy, the lack of feedback loops motivating correct information can lead to harm for participants.
...
The \hyperref[table:dilemma-personal-single-bit-decision]{Dilemma of Data for Decisions} presents a lose-lose situation: collect redundant information (which introduces additional risk of conflicting information) or hope that data collected represents reality without checking. 
...
%GV "dilemma-personal-manager-rate-of-work" [label="", shape="box"];
%GV "dilemma-personal-manager-rate-of-work" -> "";
%GV "dilemma-personal-manager-rate-of-work" -> "dilemma-personal-work-extra-or-work-as-expected";
\end{table}
\end{center}
...
%GV "dilemma-personal-talk-or-listen" -> "";
\end{table}
\end{center}
...
\label{table:dilemma-experienced-collaborators}
%GV "dilemma-experienced-collaborators" [label="experienced collaborators or not", shape="box"];
%GV "dilemma-experienced-collaborators" -> "";
\end{table}
\end{center}
...
The \hyperref[table:dilemma-experienced-collaborators]{Dilemma of Experienced Collaborators} is about the options of who to collaborate with. 

% How does this effect your relationships with other bureaucrats?

% Are the incentive structures aligned to support one direction or the other?
The bias for the \hyperref[table:dilemma-experienced-collaborators]{Dilemma of Experienced Collaborators} depends on the promotion structure of your organization and the composition of the workforce. If training new member of the team is rewarded, then you might choose to work with less experienced bureaucrats. If the entire team is experienced, then this Dilemma doesn't apply.
...
%GV "dilemma-personal-policy-consistency-across-cases" -> "consistent";
\end{table}
\end{center}
...
\label{table:dilemma-swimlanes}
%GV "dilemma-swimlanes" [label="swimlanes or not", shape="box"];
%GV "dilemma-swimlanes" -> "scope";
\end{table}
\end{center}


Independent of how tasks are assigned within a team or organization (Dilemma~\ref{table:dilemma-swimlanes}), individual bureaucrats can decide how they act in Dilemma~\ref{table:dilemma-scope-of-activity}.

% TODO: explanation of context for dilemma
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
%The \hyperref[table:dilemma-swimlanes]{Dilemma of Swimlanes}
% How does this effect your relationships with other bureaucrats?
%The \hyperref[table:dilemma-swimlanes]{Dilemma of Swimlanes}
% Are the incentive structures aligned to support one direction or the other?
...
\label{table:dilemma-scope-of-activity}
%GV "dilemma-scope-of-activity" [label="", shape="box"];
%GV "dilemma-scope-of-activity" -> "scope";
%GV "dilemma-scope-of-activity" -> "dilemma-swimlanes";
\end{table}
\end{center}
...
% TODO: explanation of context for dilemma
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
%The \hyperref[table:dilemma-scope-of-activity]{Dilemma of Scope}
% How does this effect your relationships with other bureaucrats?
%The \hyperref[table:dilemma-scope-of-activity]{Dilemma of Scope}
% Are the incentive structures aligned to support one direction or the other?
...
\label{table:dilemma-scope-of-speaking}
%GV "dilemma-scope-of-speaking" [label="", shape="box"];
%GV "dilemma-scope-of-speaking" -> "scope";
\end{table}
\end{center}
...
% TODO: explanation of context for dilemma
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
%The \hyperref[table:dilemma-scope-of-speaking]{Dilemma of Speaking Scope}
% How does this effect your relationships with other bureaucrats?
%The \hyperref[table:dilemma-scope-of-speaking]{Dilemma of Speaking Scope}
% Are the incentive structures aligned to support one direction or the other?
...
%GV "dilemma-how-many-participants" [label="", shape="box"];
%GV "dilemma-how-many-participants" -> "";
\end{table}
\end{center}
...
\label{table:dilemma-delegate-or-not}
%GV "dilemma-delegate-or-not" [label="", shape="box"];
%GV "dilemma-delegate-or-not" -> "";
\end{table}
\end{center}

% TODO: explanation of context for dilemma
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
%The \hyperref[table:dilemma-delegate-or-not]{Dilemma of Delegation}
% How does this effect your relationships with other bureaucrats?
%The \hyperref[table:dilemma-delegate-or-not]{Dilemma of Delegation}
% Are the incentive structures aligned to support one direction or the other?
...
\label{table:dilemma-health-vs-results}
%GV "dilemma-health-vs-results" [label="", shape="box"];
%GV "dilemma-health-vs-results" -> "";
\end{table}
\end{center}

% TODO: explanation of context for dilemma
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
%The \hyperref[table:dilemma-health-vs-results]{Dilemma of Health versus Results}
% How does this effect your relationships with other bureaucrats?
%The \hyperref[table:dilemma-health-vs-results]{Dilemma of Health versus Results}
% Are the incentive structures aligned to support one direction or the other?
...
%GV "dilemma-chunk-size" [label="", shape="box"];
...
External dependencies can enable broader scope. This Dilemma only is relevant if you have autonomy in the selection of your tasks. See also the Dilemma of Delegation, \ref{table:dilemma-delegate-or-not}.
}
\label{table:dilemma-number-of-external-dependencies}
%GV "dilemma-number-of-external-dependencies" [label="", shape="box"];
%GV "dilemma-number-of-external-dependencies" -> "";
\end{table}
\end{center}

% TODO: explanation of context for dilemma
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
%The \hyperref[table:dilemma-number-of-external-dependencies]{Dilemma of Dependencies}
% How does this effect your relationships with other bureaucrats?
%The \hyperref[table:dilemma-number-of-external-dependencies]{Dilemma of Dependencies}
% Are the incentive structures aligned to support one direction or the other?
...
%GV "dilemma-number-of-roles" [label="", shape="box"];
...
%GV "dilemma-how-dissent-is-responded-to" [label="", shape="box"];
%GV "dilemma-how-dissent-is-responded-to" -> "disagreement";
\end{table}
\end{center}
...
%GV "dilemma-sharing-lessons-learned" [label="", shape="box"];
%GV "dilemma-sharing-lessons-learned" -> "";
\end{table}
\end{center}
...
%GV "dilemma-lessons-learned-source" [label="", shape="box"];
%GV "dilemma-lessons-learned-source" -> "";
\end{table}
\end{center}
...
%GV "dilemma-how-to-change" [label="", shape="box"];
...
%GV "dilemma-of-batching" [label="", shape="box"];
%GV "dilemma-of-batching" -> "";
\end{table}
\end{center}
...
%GV "dilemma-of-redundancy" [label="", shape="box"];
%GV "dilemma-of-redundancy" -> "";
\end{table}
\end{center}
...
%GV "dilemma-org-people-per-supervisor" [label="", shape="box"];
%GV "dilemma-org-people-per-supervisor" -> "";
\end{table}
\end{center}
...
%GV "dilemma-org-dense-effectiveness" [label="", shape="box"];
...
%GV "dilemma-org-staff-many-vs-few" [label="", shape="box"];
%GV "dilemma-org-staff-many-vs-few" -> "";
\end{table}
\end{center}
...
%GV "dilemma-org-inhouse-vs-external" [label="", shape="box"];
%GV "dilemma-org-inhouse-vs-external" -> "";
\end{table}
\end{center}
...
%GV "dilemma-org-central-vs-distributed" [label="", shape="box"];
%GV "dilemma-org-central-vs-distributed" -> "";
\end{table}
\end{center}
...
%GV "dilemma-org-decisions-low-vs-high" [label="", shape="box"];
...
%GV "dilemma-subject-forms" [label="", shape="box"];
...
\hyperref[table:dilemma-personal-single-bit-decision]{Dilemma of Data for Decisions}

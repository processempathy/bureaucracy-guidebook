...
Once a dilemma is recognized, it is easier to defer and avoid the decision-making process.\footnote{\href{https://xkcd.com/1445/}{https://xkcd.com/1445/} -- strategy A versus strategy B versus time spent analyzing which is more efficient.\index{xkcd!\string\href{https://xkcd.com/1445/}{1445}}} Delaying a decision longer than necessary ripples out along the chain of dependencies. 
...
\begin{tabular}{ | m{\dilemmatablewidth}| m{\dilemmatablewidth} | } 
  ...
  \index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Moral_injury}{moral injury}}
  } &
...
\index{folk wisdom!\string\href{https://en.wikipedia.org/wiki/The_squeaky_wheel_gets_the_grease}{Squeaky wheel gets the grease}}
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/The_squeaky_wheel_gets_the_grease}{The squeaky wheel gets the grease}}
%%%\marginpar{$>>$ Folk Wisdom} 
and 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-speak-up-or-hold-back})}{} arises 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-early-intervention})}{} is 
...
\begin{tabular}{ | m{\dilemmatablewidth}| m{\dilemmatablewidth} | } 
  ...
  \index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Cover_your_ass}{cover your ass}}
  } &
...
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Dark_pattern}{dark patterns}}
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-notes-or-no-notes})}{} is 
...
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Analysis_paralysis}{analysis paralysis}}
}
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-forest-vs-trees})}{} is 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-meetings-versus-work})}{} is 
...
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Space_Shuttle_Challenger_disaster}{Challenger disaster}}
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-bad-news-up-the-chain})}{} is 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-emergencies-vs-ignore})}{} cannot be avoided. 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-flaws-and-innovation})}{} applies 
...
The \hyperref[table:dilemma-personal-disruptive-or-iterative]{Dilemma of Innovation} 
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-disruptive-or-iterative})}{} can 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-innovate-open-obscure})}{} identifies 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-gather-data-lots-vs-little})}{} is 
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-planning-vs-iterate})}{} identifies 
...
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Risk_assessment}{Risk tolerance}}
} 
\index{dilemma!of \string\href{https://en.wikipedia.org/wiki/Risk_assessment}{Risk tolerance}}
...
\iftoggle{printedonpaper}{ (\ref{table:dilemma-personal-risk-high-vs-low})}{} arises 
...
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Everything_which_is_not_forbidden_is_allowed}{Everything which is not forbidden is allowed}}} is used by bureaucrats to rationalize their action (or inaction). 
...
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Goldilocks_principle}{Goldilocks balance}}
}

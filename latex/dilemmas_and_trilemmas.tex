\section{Every Bureaucrat's  Dilemmas\label{sec:dilemma_trilemma}}
...
As an outsider to a team responsible for a process/policy/product, suppose you learn of something prior to official deployment (i.e., you learn the internal musings of another team). There is folk wisdom on both sides: 
...
How much data to gather for a decision. See Fig.~\ref{fig:data_collection_cost_uncertainty}. See also \S~\ref{sec:bureaucratic_debt} on bureaucratic debt.
...
\begin{tabular}{ | m{\dilemmatablewidth}| m{\dilemmatablewidth} | } 
  ...
  \hline
\end{tabular}
\caption{\textit{Dilemma of Consistency over time.} Stability of rules; how change is implemented. Can also be characterized as when to tell other people: sooner or later (when firmer information is available) See \S~\ref{sec:static-dynamic_processes} for static versus dynamic processes.
...
Acceptance or rejection of additional work.
}
...
External dependencies can enable broader scope. See also the Dilemma of Delegation, \ref{table:delegate-or-not}.
}
...
\begin{tabular}{ | m{\dilemmatablewidth}| m{\dilemmatablewidth} | } 
  ...
  \hline
\end{tabular}
\caption{\textit{Dilemma of Centralization of services.} Oscillation (see Fig.~\ref{fig:central-vs-distributed}) indicates neither solution is optimal.
%{\tiny Tag: Design of organization.}
}
...
Services within an organization. See also Fig.~\ref{fig:market-vs-monopoly}.
%{\tiny Tag: Design of organization.}
}
...
Trilemma: \textbf{Do you support the cutting edge, most of the middle, or the laggards?}\\

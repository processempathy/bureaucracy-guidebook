...
\begin{itemize}
    ...
    \item If you don't recognize the existence of the dilemmas or name them, bureaucracy can feel like resistance, confusion, conflict, and frustration. By recognizing the dilemmas specific to your situation, you can see that bureaucracy is actually a set of opportunities and potential disagreements that can be negotiated.
\end{itemize}
...
Adding to the difficulty and stress, dilemmas presented here occur concurrently and continuously. The dilemmas are interdependent due to both  the common variables and the constrained resources.
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-focus-vs-systemic})}{} is 
...
As an outsider to a team responsible for a process, policy, or product, suppose you learn of something prior to the official deployment (e.g., you learn the internal musings of another team). There is folk wisdom on both sides: 
``Stay in your lane'' 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-early-intervention})}{} is 
about knowledge your role didn't require. That knowledge may be incomplete or you may know more than the people taking action. 


% How does this effect your relationships with other bureaucrats?
The \hyperref[table:dilemma-personal-early-intervention]{Dilemma of Early Intervention} can harm your relationships if you are seen as exceeding your role. Alternatively, your action can benefit the organization, and the team taking  action may be grateful for the intervention. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-manager-micromanaging})}{} is 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-solution-provider})}{} is 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-notes-or-no-notes})}{} is 
a question of whether you avoid the risk of accountability or enable accountability of yourself and other bureaucrats. Having a written record is useful when confronted with the question, ``What did you know and when did you know it?"
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-forest-vs-trees})}{} is 
pervasive in bureaucracy. Any time not spent taking action looks wasteful, while investing too little thought can result in wasteful action. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-meetings-versus-work})}{} is 
happening all the time for many aspects of the subjective decisions being made. Advertising ``I'm going to do something," ``I'm doing something," and ``I did something" as you are progressing on any given task is vital to decreasing the likelihood of unintentional duplication. Even that activity of advertising and listening to the advertisements of other bureaucrats takes time away from doing your work. 
...
% Are the incentive structures aligned to support one direction or the other?
As with \hyperref[table:dilemma-personal-forest-vs-trees]{Dilemma of Think or Do}
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-forest-vs-trees}),}{,} inaction 
is the safer default. Having a meeting is less risky than investing time in creating a prototype. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-work-extra-or-work-as-expected})}{} is 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-bad-news-up-the-chain})}{} is 
a consequence of hierarchical reporting in organizations. Regardless of whether the hierarchy stems from the specialization of skills or the delegation of decisions, information traverses up the
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-emergencies-vs-ignore})}{} cannot be avoided. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-idea-filtering})}{} is 
one element of the broader topic of \hyperref[sec:innovation]{innovation in bureaucracy}
\iftoggle{boundbook}{ (see page~\pageref{sec:innovation}).}{.} Related dilemmas include 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-disruptive-or-iterative})}{} and 
the \hyperref[table:dilemma-personal-where-to-innovate]{Dilemma of Where to Innovate}
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-where-to-innovate}).}{.} Any 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-flaws-and-innovation})}{} applies 
...
The \hyperref[table:dilemma-personal-disruptive-or-iterative]{Dilemma of Innovation} 
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-disruptive-or-iterative})}{} can 
be disheartening for bureaucrats. The innovation is usually intended to improve the team or organization, so resistance to change demoralizes the bureaucrat. 
...
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
The \hyperref[table:dilemma-personal-where-to-innovate]{Dilemma of Where to Innovate} 
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-where-to-innovate})}{} is 
not specific to bureaucracy. Changing where work is done is disruptive. Disruption of routines can be harmful and beneficial.
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-innovate-open-obscure})}{} identifies 
the tension of useful criticism versus harmful criticism. Because bureaucracy operates in a zero-sum environment, attention and resources invested in innovation are always at risk of being cut in favor of more reliable efforts. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-recognition-obscurity})}{} is 
...
\hyperref[sec:bureaucratic-debt]{bureaucratic debt}\iftoggle{haspagenumbers}{ (see  page~\pageref{sec:bureaucratic-debt}),}{,} which is the concept of work needed to change a process. Changing a process may require collecting additional information to inform decisions. Information that was collected may no longer be relevant. 
%\iftoggle{sectionref}{%
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-gather-data-lots-vs-little})}{} is 
more nuanced than merely finding 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-planning-vs-iterate}).}{.} It 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-planning-vs-iterate})}{} identifies 
a widely applicable challenge for bureaucrats throughout an organization (top to bottom, and on every team). Regardless of whether you're planning your next day or the next few years, there will be unforeseen challenges. Do those interruptions invalidate the effort of planning?
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-risk-high-vs-low})}{} arises 
in bureaucracy because the environment around the shared resource being managed isn't static. Change requires policies and processes to change. Whether the change is small or large is dependent on the risk tolerance of individual bureaucrats involved in the decision. 
...
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/Everything_which_is_not_forbidden_is_allowed}{Everything which is not forbidden is allowed}}} is used by bureaucrats to rationalize their action (or inaction). 
...
Having a single bureaucrat make a decision is quicker than checking that bureaucrat. Validating the decision slows down the process and requires additional bureaucrats.
}
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-experienced-collaborators})}{}about the options of who to collaborate with. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-new-opportunties-yes-no})}{} depends as much on the workload as on your personality. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-data-share-vs-hide})}{} there are many of aspects of data that can be 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-data-share-vs-hide})}{} points out that the helpfulness has a cost. 
...
\iftoggle{boundbook}{ (\ref{table:dilemma-personal-cooperate-vs-compete})}{} is best addressed through explicit conversations,
both between peers and with decision-makers. These discussions may not remedy the challenge, but they provide an opportunity for you to learn more about the people in your organization.

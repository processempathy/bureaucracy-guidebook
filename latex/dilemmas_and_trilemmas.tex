...
\begin{tabular}{ | m{\dilemmatablewidth}| m{\dilemmatablewidth} | } 
  ...
  \hline
\end{tabular}
\caption{In conversations or meetings there is a (subjective) balance for participants.
}
...
%  \textit{Description}:  \\  
  ...
  \hline
\end{tabular}
\caption{How much data to share. Potential solution is to make data discoverable. Advertise the availability of data without providing data. This way a negotiation is feasible for people interested in the data.
%{\tiny Tag: Personal choice.}
}

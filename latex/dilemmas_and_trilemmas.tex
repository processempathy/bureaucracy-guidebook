...
\begin{tabular}{ | m{\dilemmatablewidth}| m{\dilemmatablewidth} | } 
  ...
  \textit{Pros}: More externally visible. \\
  \hline
\end{tabular}
\caption{
\textit{Dilemma of Flaws and Innovation.}
\index{dilemma!of flaws and innovation}
Zero-sum investment of attention in either maintenance of the status quo or making progress.
}
...
% How does this relate directly to bureaucracy as defined as shared resource management policymaking?
The \href{table:flaws-and-innovation}{Dilemma of Flaws and Innovation} applies to bureaucracy in terms of policy, and to product development.
...
% How does this effect your relationships with other bureaucrats?
The \href{table:flaws-and-innovation}{Dilemma of Flaws and Innovation} shows up in relationships in both directions. Bureaucrats recognize the value of maintenance even though it's not rewarded. 

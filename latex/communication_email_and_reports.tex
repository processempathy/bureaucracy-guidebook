...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Only the subset of emails that are important.
        \item Only the subset of emails that have short answers.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Read emails from important people only (based on sender).
...
\caption{The computer commands use fixed width font. The author distinguished input from output through the use of bold versus non-bold respectively. The author highlighted the error message using red. Inline text like ``cat'' in the last line is also fixed width.}

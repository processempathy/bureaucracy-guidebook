...
\textit{Email Tip}: Good emails balance sufficient context (the why) and relevant details (the what) against conciseness (word count). 
...
\ \\
\textit{Email Tip}: When replying to threads with sensitive messages, sanitize the included content as appropriate by removing name or identifying details.
...
\ \\
\textit{Email Tip}: If you have a sequence of steps, number them appropriately and indicate which steps are required versus optional

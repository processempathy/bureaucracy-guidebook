...
\textit{Tactic}: Presence creates priority - go to the person's desk that you're seeking a response from. 
...
I needed some data from a coworker. After trying email and phone calls multiple times, I ended up flying across the country. Once I arrived and stood in their office the person was able to provide the data in a few hours.
\end{mdframed}
%\end{storytime}

\textit{Tactic}: Merely sitting next to a coworker, even with no official purpose of interaction, results in spontaneous informal discussions. See the discussion of a 
\hyperref[sec:prisoner-exchange]{Prisoner exchange}\iftoggle{haspagenumbers}{ on page~\pageref{sec:prisoner-exchange}.}{.}

\textit{Tactic}: Take advantage of the 

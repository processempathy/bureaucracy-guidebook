...
\item The bureaucrat may not be confident in their writing ability -- spelling, grammar, sentence composition, and structuring content.\iftoggle{printedonpaper}{}{\footnote{For tips on writing, see section~\ref{sec:resources-for-writing}\iftoggle{haspagenumbers}{ on page~\pageref{sec:resources-for-writing}.}{.}}}
\end{itemize}

...
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/Allen_curve}{Allen curve}}
by implementing the Inverse Conway Maneuver: if you know what interfaces a product or process needs, then design the placement of your team members to reflect that.
...
is a scenario in which two participants have conflicting objectives and are unable to coordinate. (See page~\pageref{prisoners_dilemma_explanation} for more details.) Each participant has to guess what another person in their position might do. An inability to coordinate leads to suboptimal conclusions. For bureaucrats in similar conditions, options include
\begin{itemize}

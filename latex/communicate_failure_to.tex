...
This section on failure outlines how ineffective communication happens. Identifying generic sources of difficulty is intended to help you distinguish what is common in bureaucratic organizations versus what is specific to your team. 


\ \\

Sometimes a failure to communicate is caused to by too much (ineffective) communication. 
When there is a lot of communication happening (whether too many sources or too much content), you can get overwhelmed.
...
Improvement in communication effectiveness are more than just a time saver.
Poor communication yields poor negotiation. When negotiations are not happening, then the interaction defaults to an emotional struggle of will power. 
...
%%%TODO\marginpar{[Wikipedia] Allen\\curve}
...
\begin{mdframed}
I once needed some data from a coworker. After trying email and phone calls, I ended up flying across the country. Once I arrived the person was able to provide the data in a few hours.
\end{mdframed}

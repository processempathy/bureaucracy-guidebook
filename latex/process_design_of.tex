...
\index{Goldilocks principle!number of processes}
\begin{itemize}
...
\index{Wikipedia!Laffer curve@\href{https://en.wikipedia.org/wiki/Laffer_curve}{Laffer curve}}

Because bureaucrats are typically not formally trained in designing processes, ad hoc ideas reactive to the immediate situation and local constraints are used. A thoughtful process designer tries to account for exceptions
\iftoggle{haspagenumbers}{ (page~\pageref{sec:exceptions-to-process})}{} 
...
The following sections describe why static process designs are the norm, the role of bureaucratic
 debt\iftoggle{haspagenumbers}{ (page~\pageref{sec:bureaucratic-debt})}{}, and 
 how to design for turnover of staff\iftoggle{haspagenumbers}{ (page~\pageref{sec:turnover})}{}.

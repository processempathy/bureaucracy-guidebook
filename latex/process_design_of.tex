...
Because bureaucrats are typically not formally trained in designing processes, ad hoc ideas reactive to the immediate situation and local constraints are used. A thoughtful process designer attempts to account for exceptions \iftoggle{haspagenumbers}{ (page~\pageref{sec:exceptions-to-process})}{} 
...
Another question to ask when designing a bureaucratic process is whether a process is actually needed. Can the goal be accomplished by relying on ad hoc responses and leveraging relationships among bureaucrats?

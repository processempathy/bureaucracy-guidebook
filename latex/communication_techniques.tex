...
\textit{Communication Tip}: \textbf{Avoid Platitudes\label{sec:platitudes}}.\\
...
are \gls{thought terminating}; the statement feels true and is resistant to debate. Platitudes capture a feeling with sufficient accuracy, but with imprecise language. As a result, there's no specific action.
...
\index{folk wisdom!Warnock's dilemma}

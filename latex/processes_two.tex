\section{Processes involving two Organizations}

When two independently-governed processes interact, there can be friction. Process friction, especially between two  organizations that lack shared coordination, results in either exceptions to the process (section~\ref{sec:exceptions-to-process}) or lying or change in process (section~\ref{sec:change_a_process}). 

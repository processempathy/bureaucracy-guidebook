...
%\textit{Summary}: 
You have experience with bureaucracy, though you may not have framed the experiences as bureaucratic. You might not have used the labels of policymaker, bureaucrat, or subject, but you may have acted in all three roles. 
%By appropriately labeling the situations you can leverage your experience in new contexts. 
If you recognize you've been acting as a bureaucrat you'll be able to apply relevant skills. 
%Viewing relationships and roles through the lens of bureaucracy explains the limitations of your expectations.

\ \\

In each person's life there are milestones like birth, education, work, and death. 
%The relationships associated with each phase are distinct.
Each of these milestones and phases involves bureaucracy, so you are have experience with each of the roles that constitute bureaucracy. Each phase in your life provides a different experience of bureaucracy.% because the circumstances change.
...
%These roles can be confounded by misusing the label ``bureaucrat." 
Who is the bureaucrat and who is the subject depends on the relationship in a scenario. 
For example, a store manager creates a policy, a store clerk enforces the policy, 
\index{exemplar!store clerk}
and the policy is inflicted on the customer. %Both the manager and the store clerk would be bureaucrats, while 
The customer is the subject of bureaucracy. In a separate example, someone at corporate headquarters sets a policy, the store manager enforces it, and the policy is inflicted on the store clerk. Then the clerk was the subject of bureaucracy. 
...
For some students schooling can emphasize academics over socializing. When transitioning to professional work the social skills and political savvy are necessary when trying to change the policies of your team or organization. An effective bureaucrat is more than just book-smart. 
...
%The \textit{holistic view} is that someone didn't refill the toilet paper. 
...
%Minimizing checking of toilet paper is important for the organization's reputation, so 

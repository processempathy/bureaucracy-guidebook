...
%The purpose of pointing out the variables that can be changed is to show that there aren't many. 
...
For interactions among team members at the same hierarchical level the conflict of interests between cooperation and competition manifests in struggles over money, staffing, products (output), and resources (inputs). 
% following sentence is a dupe from the previous list of resources
%Here ``resources''  refers to constraints like access to data, control of data, technology resources, hardware, floor space, and expertise. 

...
is part of the explanation for patterns observed when people coordinate. A separate explanatory factor is how tasks get distributed among members of an organization. These two aspects of participating in an organization are often confounded. This appendix describes a model of processes and tasks that involve only coordination. The purpose of the model in this appendix is to distinguish aspects of an organization that are not attributable to bureaucracy. 
...
\begin{itemize}
    ...
    \item Skill-levels are discrete. The justification is that there are tasks that are inaccessible to some skill-levels. For example, 10 high school students are unlikely to be able to complete a task that one PhD physicists can do. 
...
\centering
%\includegraphics[width=1\textwidth]{images/task_distribution_tasks_per_person_simCount1_skills2_levels1_taskduration1_people6_social0_ticks100_annotated.pdf}

\iftoggle{narrowpage}{\newcommand\imgwidth{1}}{\newcommand\imgwidth{0.7}}

\includegraphics[width=\imgwidth\textwidth]{images/z_flattened_annotation.pdf}

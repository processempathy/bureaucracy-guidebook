...
\index{Wikipedia!\string\href{https://en.wikipedia.org/wiki/Chaos_theory}{chaos theory}}
...
\hyperref[sec:turnover]{personnel turnover}\iftoggle{haspagenumbers}{; see page~\pageref{sec:turnover}.}{.}

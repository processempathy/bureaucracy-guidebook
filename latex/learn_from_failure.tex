...
Making progress in a bureaucracy is not a linear sequence of steps. Ideally there is an ongoing cycle of trying something, not succeeding, and then applying what you learn towards the next try. This idealized ``\href{https://en.wikipedia.org/wiki/Fail-fast#Business}{fail fast}'' 
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/Fail-fast#Business}{fail fast}}\iftoggle{WPinmargin}{\marginpar{$>$Wikipedia: Fail-fast}}{}

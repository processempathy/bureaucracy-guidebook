...
\usepackage[marginparwidth=.8in,paperwidth=5.5in,paperheight=8.5in,textwidth=3.75in,top=.75in,bottom=.5in, inner=.7in]{geometry}
\else
% "the default page size for all standard document classes is US letter" - https://en.wikibooks.org/wiki/LaTeX/Page_Layout#Page_size
\documentclass[oneside]{book}
% https://tex.stackexchange.com/a/137024/235813
\usepackage[left=0.75in,textwidth=5.5in,marginparsep=0.25in,marginparwidth=1.5in,bottom=1in,top=1in]{geometry}
\fi

% 5.5" wide book has .6" separation between binding and text
...
% * printed PDF (8.5x11), double sided. No hyperlinks. Has page numbers. Has margin comments.
...
\usepackage{array}
\iftoggle{narrowpage}{\newcommand{\dilemmatablewidth}{4.3cm}}{\newcommand{\dilemmatablewidth}{6.5cm}}
...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Process Empathy: The Field Guide for Effective Bureaucrats},
...
\iftoggle{showbacktotoc}{\ \\}{}
  ...
  \iftoggle{showminitoc}{\minitoc}{}
    ...
    As a bureaucrat, understanding your options for action matters. You're less effective if you don't know what your options are. If you are ok with being ineffective or are not feeling the harm of your ineffectiveness, keep in mind that
    there is no neutral member of a bureaucracy. Either you are contributing to the organization, or you are sapping resources from the organization. This dichotomy exists because the organization operates in a zero-sum game for resource allocation.
...
\iftoggle{glossarysubstitutionworks}{\Gls{bureaucracy}}{Bureaucracy}
    is distributed decision-making and distributed knowledge associated with management of shared resources. Bureaucrats rely on a variety of mechanisms to communicate, one of which is a meeting with other bureaucrats.\footnote{See also Zhuo's Chapter 6 in~\cite{2019_Zhuo}} 

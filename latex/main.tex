...
\chapter{Bureaucracy in general}
  ...
  \input{efficient_bureaucracy} \clearpage
...
% unordered essays to be clustered later
  ...
  \input{internal_product_development_deployment}
  \newpage
  \input{processes}
...
The relevant attributes are synchronous versus asynchronous. Searchable or not searchable. In that context, there might be some interesting bureaucratic specific things to think about
  ...
  \section{Meetings within a Bureaucracy}
    ...
    Meeting types: scheduled one-on-ones, impromptu walk-around, conferences.  
    \input{one-on-ones}
...
\chapter{Book notes}
\input{book_notes_blau_dynamics_of_bureaucracy}\newpage
\input{book_notes_dugay_values_of_bureaucracy}\newpage
...
\input{book_notes_vine_bureaucracy_a_key_idea_for_business_and_society}\newpage
\input{book_notes_vonmises_bureaucracy}\newpage

...
% unordered essays to be clustered later
  ...
  \section{Bureaucratic Processes}
    ...
    \input{processes_two}
    \input{process_tax_on_productivity}
...
\chapter{Book notes}
\input{book_notes/blau_dynamics_of_bureaucracy}\newpage
\input{book_notes/dugay_values_of_bureaucracy}\newpage
...
\input{book_notes/lipsky_street-level_bureaucracy}\newpage
\input{book_notes/ohearn_bureaucrats_handbook}\newpage
\input{book_notes/vine_bureaucracy_a_key_idea_for_business_and_society}\newpage
\input{book_notes/vonmises_bureaucracy}\newpage
\input{book_notes/wilson_bureaucracy}

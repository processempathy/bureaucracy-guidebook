...
\title{Process Empathy Field Guide:\\
...
\input{communication_within_bureaucracy} % chapter
    ...
    \input{friction_between_teams_within_organization} \clearpage 
  ...
  \minitoc
    ...
    \input{process_change_existing} % no clearpage here because next input is subsection
    \input{process_tactic_approval_forgiveness_opposition} \clearpage
    \input{process_deployment} \clearpage
    \input{processes_two} \clearpage
    \section{Design of Processes}

...
%(see section~\ref{sec:dilemma_trilemma}).
...
%section~\ref{sec:reducing_overhead} for details.
...
\ \\
\textit{Bureaucratic Fallacy}: 
\textbf{You cannot pay a little and get a lot}; see \href{https://en.wikipedia.org/wiki/Common_law_of_business_balance}{Common law of business balance}. \marginpar{[Tag] Folk wisdom} \index{folk wisdom!\href{https://en.wikipedia.org/wiki/Common_law_of_business_balance}{Common law of business balance}} \\

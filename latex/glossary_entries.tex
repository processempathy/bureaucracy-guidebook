...
description={community resource -- either tangible items (e.g., land, air, water) or expertise -- with associated policies and enforcement. Examples:
\begin{itemize}
...
\item A prison is a bureaucracy; guards are the bureaucrats enforcing policy. 
...
\item A library is a shared resource. Librarians are bureaucrats.
...
\item A stairwell is a shared resource. Example policy: don't sleep in the stairwell; don't sell items in the stairway. Bureaucrat is the building manager and the fire marshall. 
...
\newglossaryentry{bureaucracy}{
    ...
    text={bureaucracy},
    description={
    The set of subjective decisions made by individual participants in an organization. The decisions originate from the management of shared resources. The resources can be either tangible or in the form of expertise. Bureaucracy relies on distributed knowledge and distributed decision making. 
    \\

...
\newglossaryentry{decentralized bureaucracy}{
    ...
    Large bureaucracy is necessary when no one bureaucrat can carryout the relevant policies (due to complexity or size). In the situation  distributed knowledge and distributed decision-making are essential}
}
...
\newglossaryentry{core bureaucracy}{
    ...
    \end{itemize}
Each of the above two scenarios have a shared resource, policy maker, and subject}
}

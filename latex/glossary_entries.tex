...
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/Thought-terminating_clich\%C3\%A9}{Thought-terminating cliche}}
...
\newglossaryentry{bureaucrat}{
    name={bureaucrat},
    plural={bureaucrats},
    description={A person responsible for subjective implementation of policy addressing access to 
...
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/Empathy}{empathy}}
is concerned with emotions like sadness, happiness, anger}
}

\newglossaryentry{intellectual empathy}{
name={intellectual empathy},
description={Thinking how another person thinks. If you possess a capacity for \href{https://en.wikipedia.org/wiki/Theory_of_mind}{Theory of Mind}, 
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/Theory_of_mind}{Theory of Mind}}
you are able to predict another person's intent}
}
...
Each successive contributor may have had good intent, but their improvement may add complexity by introducing new dependencies. 
...
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/G._K._Chesterton\%23Chesterton's_fence}{Chesterton's fence}}
...
For example pay, promotion, titles, stability, awards}
}
...
\item The \gls{decision archaeology} of determining why things are the way the are, what is the overarching intent.
...
\index{exemplar!\href{https://en.wikipedia.org/wiki/Department_of_transportation}{Department of Transportation}}

...
\newglossaryentry{policymaker}{
   name={policymaker},
   plural={policymakers},
   description={Determines access to a shared resource}
}
...
\item A road used by cars and trucks and buses is a shared resource. Police are bureaucrats and drivers are the subjects.
...
\index{Wikipedia!wicked problem@\string\href{https://en.wikipedia.org/wiki/Wicked_problem}{wicked problem}}
    ...
    \textit{There is a separate sense that is commonly used so I include it here.} An \gls{organization} of 
\iftoggle{glossarysubstitutionworks}{\glspl{bureaucrat}}{bureaucrats}
comprises a bureaucracy. A bureaucratic organization relies on distributed knowledge and distributed decision-making.
A bureaucracy facilitates coordination of 
\iftoggle{glossarysubstitutionworks}{\glspl{stakeholder}}{stakeholders} enacting policies.
...
description={Consequences for the decision-maker. Also known as ``skin in the game"}
}

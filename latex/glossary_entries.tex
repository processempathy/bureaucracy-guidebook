...
name={visible bureaucracy},
    ...
    description={
\ifglossarysubstitutionworks
\Glspl{process} \else Processes\fi
are written down and can be discovered by 
\ifglossarysubstitutionworks
\glspl{stakeholder} \else stakeholders\fi}
}
...
\ifglossarysubstitutionworks
\glspl{policy} \else policies \fi
enforced by 
\ifglossarysubstitutionworks
\glspl{bureaucrat}. \else bureaucrats.
\fi

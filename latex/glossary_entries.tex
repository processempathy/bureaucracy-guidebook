...
\newglossaryentry{distributed bureaucracy}{
    ...
    Arises when no one bureaucrat can carryout the policy (due to complexity or scale), so  distributed knowledge and distributed decision-making are essential}
}

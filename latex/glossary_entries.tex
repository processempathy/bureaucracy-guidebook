...
The label of ``shared resoure'' is used here even when the status of whether the resource is shared is contentious. For example, a private property owner of land may view their land a not-shared, but another person may walk across that land. This may invoke involvement of the police to arrest the tresspasser. There's contention for access to the resource. \\

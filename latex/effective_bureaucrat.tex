...
%CANTDO\marginpar{Page~\pageref{sec:unavoidable-hazards}.} 
...
\index{Wikipedia!project management@\href{https://en.wikipedia.org/wiki/Project_management}{project management}}
...
Bureaucracy is typically enacted by a system of distributed knowledge and distributed decision-making, so coordination is critical. Here are characteristics to strive for. 
\begin{itemize}
    ...
    \marginpar{Page~\pageref{sec:effective-presentations}.}% 
    and \hyperref[sec:walk-arounds]{informal interactions}. \\
%CONFLICTING\marginpar{Page~\pageref{sec:walk-arounds}} \\
    ...
    \item You are 
\marginpar{Page~\pageref{sec:professional-vulnerability}.}%
...
\iftoggle{WPinmargin}{\marginpar{$>$Wikipedia: pipeline (computing)}}{}
    ...
    \index{Wikipedia!Theory of mind@\href{https://en.wikipedia.org/wiki/Theory_of_mind}{Theory of Mind}}
    ...
    \index{Wikipedia!job shadow@\href{https://en.wikipedia.org/wiki/Job_shadow}{job shadow}}
...
\index{Goldilocks principle!number of tasks}%
...
% MORE INSIGHT NEEDED if I'm going to include this
%\ \\

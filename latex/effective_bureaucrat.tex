...
%%%TODO\marginpar{[Wikipedia] project\\management}
...
\begin{itemize}
    ...
    %%%TODO\marginpar{See page~\pageref{sec:presentations}} 
...
\item You adapt to the varying incentives and reference experiences of those around you. Flexibility enables interactions with diverse coworkers. 
    ...
    %%%TODO\marginpar{[Wikipedia] pipeline\\(computing)}
...
%%%TODO\marginpar{[Wikipedia] deindividuation}
...
%%%TODO\marginpar{[Wikipedia] Chesterton's\\fence}
...
%%%TODO\marginpar{[Wikipedia] externality}

\section{How to be an Effective Bureaucrat\label{sec:effective-bureaucrat}}

Elsewhere in this book I've described 
...
With this view of the complexity of bureaucracy, how can you leverage that insight?

My baseline assumptions are that you are a good person, you have the relevant technical skills for your duties, and you are a good project manager. 
...
\item You seek information from stakeholders without burdening them.
...
\item You adapt the the varying incentives and reference experiences of those around you.
    ...
    \item You have \gls{process empathy}. Observe deviations and exceptions that cause processes to come into existence. 
...
\item Each of your tasks have a customer, a deadline, and a deliverable artifact.
...
Look up stream, look downstream. Look to peers. Zoom in (narrower scope) and zoom out (broader scope).

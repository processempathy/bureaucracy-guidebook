...
\Gls{stonewalling} \else Stonewalling \fi
...
\marginpar{See page~\pageref{sec:email-responsiveness}.}
...
\index{Wikipedia!\href{https://en.wikipedia.org/wiki/Passive-aggressive_behavior}{passive-aggressive behavior}}
\marginpar{[Wikipedia] Passive-\\aggressive behavior}
...
\marginpar{[Tag] Glossary}
\ifglossarysubstitutionworks
\Gls{bikeshedding} \else Bikeshedding \fi 
...
\marginpar{[Wikipedia: Law\\of Triviality]}

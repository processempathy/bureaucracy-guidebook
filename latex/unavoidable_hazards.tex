...
Good ideas are not sufficient for adoption or continuation.
...
\begin{itemize}
    ...
    \item Re-negotiation for additional time (a burden to both parties).
    ...
    \item Even if the bureaucrat is getting paid by the hour, additional work means the end product will be delayed to accommodate additional features (yielding a less happy customer).
\end{itemize}

...
in the bureaucracy}. \\
A specific task needs to be completed, and action requires the involvement of multiple collaborators. In this scenario there's a risk of each participant not feeling ownership over the outcome. This risk is more likely when roles are less well-defined or when participants don't have relationships to maintain. 

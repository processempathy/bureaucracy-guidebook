...
% TODO: make a better diagram, 
    ...
    \begin{figure}
        ...
        \caption{As the depth of a hierarchical organization increases, the ratio of workers to managers approaches an asymptotic value that depends on the number of workers per manager. The ``branching'' parameter is number of workers per manager.}

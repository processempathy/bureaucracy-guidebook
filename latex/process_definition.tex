...
Bureaucratic organizations manage access to shared resources (tangible or expertise). 
...
Creating and maintaining processes is burdensome, as is dealing with exceptions. This is the \hyperref[table:dilemma-personal-policy-consistency-across-cases]{Dilemma of Consistent Policies}\iftoggle{haspagenumbers}{ described on page~\pageref{table:dilemma-personal-policy-consistency-across-cases}.}{.}
...
When there is insufficient staffing then individual bureaucrats have multiple roles. This can lead to a 
...
% previously used "temporal inefficiency" instead of slowdowns
...
Processes with fewer people and fewer steps can be quicker and use fewer resources, but they are more fragile and likely to be particular to the administering bureaucrat. Having more people involved helps with edge cases but slows down the process.  Hero culture is rarely an intentional design; it is based on personalities and cost to the organization. Enabling redundancy in the form of a buddy system (e.g., \href{https://en.wikipedia.org/wiki/Pair_programming}{pair programming} 
...
\marginpar{$>>$ Actionable Advice}%
\index{actionable advice}%
Instead of bringing food when a favor is needed, bring food repeatedly before the favor is needed. Again, trust is built of over time. 
\end{itemize}

...
Bureaucratis manage access to shared resources (tangible or expertise). 
A decision about a resource that is administered by bureaucrats is formalized as a \gls{policy} so that other bureaucrats can cite and apply consistent decisions.
...
%(e.g., \href{https://en.wikipedia.org/wiki/Pair_programming}{pair programming} 

...
This section addresses changing the bureaucratic organization you are a member of. Change can be 
\hyperref[sec:change-a-process]{with respect to processes} 
\ifsectionref
(described in section~\ref{sec:change-a-process}) 
\fi
or changing the \gls{culture} of the organization.
...
\marginpar{[Tag] folklore}
\index{folklore!\href{https://en.wikipedia.org/wiki/Wikipedia:Chesterton\%27s_fence}{Chesterton's fence}}
\begin{quote}

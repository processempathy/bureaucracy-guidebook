...
The expectations of culture should be stated explicitly. If the explicitly stated norms conflict with what is experienced by the organization's members, the hypocrisy decimates trust. 
...
You can reinforce examples of desired behavior with public praise and meaningful rewards. You can punish examples of undesirable norms. 
...
(see page~\pageref{concept:chestertons_fence}) is that you shouldn't change something until you understand why things are the way they are. Figuring out the history of an issue requires work when there is a lack of historical records.

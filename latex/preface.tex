...
is the process of enacting policies through subjective decisions made by an individual managing access to a shared resource.  
\end{quote}
...
Sources of friction in a well-run bureaucracy stem from  ambiguity, conflicting incentives, finite attention, and inadequate resources. Bureaucracy is only necessary because the shared resources are scarce. There's not enough to satisfy the needs of the community. Therefore distributed decision-making and distributed knowledge are relevant for the allocation of those resources.

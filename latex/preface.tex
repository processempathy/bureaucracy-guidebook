...
%\ i f t  oggle{ W P i n margin}{\marginpar{$>$Wikipedia: saboteurs}}{}
...
%\ i f t oggle{ W P i n margin}{\marginpar{$>$Wikipedia: blinded-experiment}}{}%
...
%\ i f t oggle{ h a s p a genumbers}{ (page~\pageref{sec:fundamentals-of-b})}{}%

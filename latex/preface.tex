...
Having a precise definition of bureaucracy enables a more nuanced discussion. The clarity of your thinking enables your effectiveness.\nolinebreak 
\begin{quote}
\textbf{Definition}: 
\iftoggle{glossarysubstitutionworks}{\Gls{bureaucracy}}{Bureaucracy}
is the process of enacting policies through subjective decisions, typically in the context of managing access to a shared resource. Three roles are required: policymaker, bureaucrat, and subject.
\end{quote}
...
acknowledges non-governmental bureaucracy.} equate government to bureaucracy, but by the definition in this book bureaucracy is not limited to governments. Instead, government is an instance of where bureaucracy occurs. Therefore this book uses the word ``organization'' to encompass governments, corporations, non-profits, or any collection of people managing access to shared resources. As a consequence, many people are bureaucrats. 
The concepts and techniques in this book are derived from this definition. For example, in an organization comprised of bureaucrats typically no person knows everything and no person decides everything, so bureaucracy relies on distributed knowledge and distributed decision-making amongst people with distinct roles.
...
%<<DEPRECATED>> If you don't think of yourself as a bureaucrat, I hope to change your mind on this essential topic. 
...
%Just as this book doesn't provide input on being a good person, advice for protecting yourself from the  
%risk missing critical challenges of bureaucracy


The morals of bureaucrats~\cite{2009_Jackall} and their norms (the expectations for individuals and organizations) shift over time, while bureaucracy is persistent. In this book I focus on culturally invariant aspects of bureaucracy. 
...
The complexities of bureaucracy arise even with these simplifying assumptions and setting aside the topics listed in the previous section. %Guidance on how to be an effective bureaucrat is intended to apply to bureaucracy that benefits everyone.
...
and \hyperref[sec:unavoidable-hazards]{unavoidable hazards}\iftoggle{haspagenumbers}{~(page~\pageref{sec:unavoidable-hazards}).}{.}
...
are the guide. 
You can read each chapter of the guide (\ref{sec:individual-in-org}-\ref{sec:process}) independently. 
...
\begin{figure}[ht]
    ...
    \caption{Relation of the concepts discussed in this book.}

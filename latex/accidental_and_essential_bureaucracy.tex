...
\iftoggle{glossaryinmargin}{\marginpar{[Glossary]}}{} Achieving this minimum is tricky since optimization can be with respect to resilience to change, resilience to edge cases, staff turn-over, speed experienced by consumer, financial cost, time spent by the organization, and number of staff. Miss any one of those goals and the bureaucracy is deemed inefficient.

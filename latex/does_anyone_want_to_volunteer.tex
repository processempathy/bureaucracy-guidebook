...
\begin{enumerate}
    ...
    \item Ask each person willing to participate how much time they able to invest. Responses could be zero hours, one hour (non-recurring), one hour per month, or something else.

\section[Building, Managing, and Spending Reputation]{Building, Managing, and Spending Reputation\label{sec:reputation}\iftoggle{shortsectiontitle}{\sectionmark{Building Reputation}}{}}
...
%How does a person create and accumulate political capital? What does political capital mean for teams?

Within a bureaucratic organization the interaction of bureaucrats is based on both 
\index{Wikipedia!quid pro quo@\href{https://en.wikipedia.org/wiki/Quid_pro_quo}{quid pro quo}}%
\href{https://en.wikipedia.org/wiki/Quid_pro_quo}{quid pro quo} and coercion (e.g., sanctions). 
Good news: you have some input on your reputation, and that influences how other people engage with you. 
...
Whether for your own reputation or that of your team or organization, be careful to get a return on the investment. 

...
% https://graphthinking.blogspot.com/2017/03/what-slows-down-bureaucracy.html
    ...
    \marginpar{Page~\pageref{sec:slowing-communication}.}
    \item Participants are late to meetings.
    \item \hyperref[sec:scope-creep]{Scope creep} 
    \marginpar{Page~\pageref{sec:scope-creep}.}%
...
\marginpar{Page~\pageref{table:dilemma-subject-consistency-per-situation}.}%
...
\marginpar{Page~\pageref{table:dilemma-subject-transparency}.}%
...
\end{itemize}
Those are typically distinct to each person.
...
\marginpar{Page~\pageref{sec:dilemma-trilemma}.}%
...
\marginpar{Page~\pageref{sec:single-decider}.}%

...
\hyperref[sec:decision-making]{Decision making} %(section~\ref{sec:decision-making}) 
...
%; see section~\ref{sec:hierarchy_of_roles}.
...
%section~\ref{sec:written-communication} 

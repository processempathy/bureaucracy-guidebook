...
% TODO
Why innovation is stifled by bureaucracy
\iftoggle{haspagenumbers}{(see page~\pageref{sec:innovation})}{}
and what to do about it -- \hyperref[sec:extending-Heilmeier]{extended Heilmeier questions}
\iftoggle{haspagenumbers}{(see page~\pageref{sec:extending-Heilmeier}).}{.}

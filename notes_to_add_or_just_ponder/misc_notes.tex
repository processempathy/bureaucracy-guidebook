...
* explain how the continents of that chapter build process empathy for the reader
...
Each section needs a thesis
Each section needs to explain how this is relevant to making you more effective as a bureaucrat
